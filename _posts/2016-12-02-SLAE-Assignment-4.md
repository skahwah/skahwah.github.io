...
5. Setting general purpose registers<br>
...
7. Setting general purpose registers<br>
...
9. `jmp short EncodedShellcode`<br>
...
encoded_shellcode:
  ...
  EncodedShellcodeLen equ $-EncodedShellcode
```
The decoder can also be found <a href="https://github.com/skahwah/slae/blob/master/assignment4/decode.nasm">here</a>.
